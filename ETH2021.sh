wget https://us.download.nvidia.com/tesla/460.32.03/nvidia-driver-local-repo-ubuntu1804-460.32.03_1.0-1_amd64.deb
sudo dpkg -i nvidia-driver-local-repo-ubuntu1804-460.32.03_1.0-1_amd64.deb
sudo apt-key add /var/nvidia-driver-local-repo-460.32.03/7fa2af80.pub
sudo apt-get update
